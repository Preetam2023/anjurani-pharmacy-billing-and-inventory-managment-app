...
def get_medicine_name_suggestions(prefix, limit=10):
    """
    Returns medicine suggestions while typing in the Add Medicine dialog.
    Only used for suggestions, does NOT affect saving logic.
    """
    conn = get_connection()
